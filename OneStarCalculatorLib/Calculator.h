...
extern "C"
{
	...
	__declspec(dllexport) void SetFirstCondition(int iv0, int iv1, int iv2, int iv3, int iv4, int iv5, int fixedIV, int flawlessIDX, int ability, int nature, int characteristics, bool isNoGender, bool isEnableDream);
