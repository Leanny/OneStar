...
namespace SeedSearcherTest
{
    ...
    public class UnitTest1
    {
        ...
        public void Test_Fixed2_6_Deviation0()
        {
            ...
            searcher.RegisterLSB(0);
            searcher.RegisterPokemon1(31, 16, 31, 6, 10, 3, 2, 1, 19, 2, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(31, 11, 31, 31, 6, 19, 3, 0, 0, 2, 1, 0, 0, false, false);
        ...
        public void Test_Fixed2_6_Deviation27()
        {
            SeedSearcher searcher = new SeedSearcher(SeedSearcher.Mode.Star35);
            searcher.RegisterLSB(0);
            searcher.RegisterPokemon1(31, 31, 20, 10, 29, 30, 2, 1, 2, 0, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(31, 31, 10, 29, 31, 30, 3, 1, 2, 0, 1, 0, 0, false, false);
            searcher.RegisterPokemon3(31, 24, 16, 31, 3, 19, 2, 0, 21, 4, 2, 0, 0, false, false);
            searcher.RegisterPokemon4(29, 31, 23, 21, 1, 31, 2, 0, 12, 1, 3, 0, 0, false, false);
            int[] target = { 20, 10, 29, 30, 25, 8 };
            var res = searcher.Calculate(27, target);
            Assert.IsTrue(res.Count > 0, "No seed found");
            Assert.AreEqual(0x327499d6a1f87dfbul, res[0]);
        }
        [TestMethod]
        ...
        public void Test_Fixed3_6_Deviation1()
        {
            SeedSearcher searcher = new SeedSearcher(SeedSearcher.Mode.Star35);
            searcher.RegisterLSB(1);
            searcher.RegisterPokemon1(31, 31, 29, 31, 19, 4, 3, 1, 5, 0, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(31, 31, 19, 31, 4, 31, 4, 1, 5, 0, 1, 0, 0, false, false);
            searcher.RegisterPokemon3(15, 25, 22, 31, 6, 31, 2, 1, 8, 3, 2, 0, 0, false, false);
            searcher.RegisterPokemon4(18, 30, 31, 19, 29, 31, 2, 1, 6, 2, 3, 0, 0, false, false);
        ...
        public void Test_Fixed3_6_Deviation2()
        {
            SeedSearcher searcher = new SeedSearcher(SeedSearcher.Mode.Star35);
            searcher.RegisterLSB(0);
            searcher.RegisterPokemon1(22, 31, 6, 31, 1, 31, 3, 1, 8, 1, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(31, 31, 22, 31, 15, 31, 4, 1, 4, 0, 1, 0, 0, false, false);
        ...
        public void Test_Fixed3_6_Deviation4()
        {
            SeedSearcher searcher = new SeedSearcher(SeedSearcher.Mode.Star35);
            searcher.RegisterLSB(1);
            searcher.RegisterPokemon1(14, 31, 19, 31, 31, 22, 3, 1, 20, 4, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(20, 31, 5, 31, 31, 31, 4, 0, 1, 3, 1, 0, 0, false, false);
            searcher.RegisterPokemon3(2, 31, 5, 26, 19, 31, 2, 1, 16, 1, 2, 0, 0, false, false);
            searcher.RegisterPokemon4(31, 17, 29, 31, 19, 4, 2, 1, 5, 0, 3, 0, 0, false, false);
        ...
        public void Test_Fixed3_6_Deviation7()
        {
            SeedSearcher searcher = new SeedSearcher(SeedSearcher.Mode.Star35);
            searcher.RegisterLSB(0);
            searcher.RegisterPokemon1(1, 15, 31, 16, 31, 31, 3, 1, 14, 2, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(15, 31, 31, 16, 31, 31, 4, 1, 14, 2, 1, 0, 0, false, false);
            searcher.RegisterPokemon3(31, 13, 8, 31, 11, 10, 2, 1, 10, 0, 2, 0, 0, false, false);
            searcher.RegisterPokemon4(31, 1, 27, 8, 1, 31, 2, 0, 9, 0, 3, 0, 0, false, false);
        ...
        public void Test_Fixed3_6_Deviation9()
        {
            SeedSearcher searcher = new SeedSearcher(SeedSearcher.Mode.Star35);
            searcher.RegisterLSB(0);
            searcher.RegisterPokemon1(20, 31, 22, 31, 28, 31, 3, 0, 17, 4, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(22, 31, 28, 31, 31, 31, 4, 0, 17, 4, 1, 0, 0, false, false);
            searcher.RegisterPokemon3(28, 31, 31, 2, 0, 12, 2, 1, 12, 1, 2, 0, 0, false, false);
            searcher.RegisterPokemon4(2, 17, 8, 23, 31, 31, 2, 1, 11, 3, 3, 0, 0, false, false);
            int[] target = { 20, 22, 28, 24, 30, 17 };
            var res = searcher.Calculate(9, target);
            Assert.IsTrue(res.Count > 0, "No seed found");
            Assert.AreEqual(0xda1db3506d655553ul, res[0]);
        }
        [TestMethod]
        public void Test_Fixed3_6_Deviation10()
        {
            SeedSearcher searcher = new SeedSearcher(SeedSearcher.Mode.Star35);
            searcher.RegisterLSB(0);
            searcher.RegisterPokemon1(31, 19, 31, 14, 31, 25, 3, 1, 20, 2, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(31, 14, 31, 31, 31, 25, 4, 1, 20, 2, 1, 0, 0, false, false);
            searcher.RegisterPokemon3(31, 9, 31, 3, 31, 3, 2, 1, 11, 5, 2, 0, 0, false, false);
            searcher.RegisterPokemon4(31, 31, 6, 15, 21, 16, 2, 0, 17, 0, 3, 0, 0, false, false);
            int[] target = { 19, 14, 25, 9, 30, 30 };
            var res = searcher.Calculate(10, target);
            Assert.IsTrue(res.Count > 0, "No seed found");
            Assert.AreEqual(0x3a2a4a70e6a53651ul, res[0]);
        }
        [TestMethod]
        public void Test_Fixed3_6_Deviation11()
        {
            SeedSearcher searcher = new SeedSearcher(SeedSearcher.Mode.Star35);
            searcher.RegisterLSB(1);
            searcher.RegisterPokemon1(31, 9, 25, 31, 31, 12, 3, 0, 22, 4, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(31, 31, 25, 31, 31, 12, 4, 0, 22, 4, 1, 0, 0, false, false);
            searcher.RegisterPokemon3(3, 4, 31, 31, 2, 24, 2, 1, 6, 4, 2, 0, 0, false, false);
            searcher.RegisterPokemon4(31, 10, 31, 30, 13, 8, 2, 1, 13, 0, 3, 0, 0, false, false);
            int[] target = { 9, 25, 12, 28, 6, 22 };
            var res = searcher.Calculate(11, target);
            Assert.IsTrue(res.Count > 0, "No seed found");
            Assert.AreEqual(0x56cc20e375d566eul, res[0]);
        }
        [TestMethod]
        ...
        public void Test_Fixed3_6_Deviation14()
        {
            SeedSearcher searcher = new SeedSearcher(SeedSearcher.Mode.Star35);
            searcher.RegisterLSB(0);
            searcher.RegisterPokemon1(31, 13, 16, 31, 31, 19, 3, 1, 24, 0, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(31, 16, 19, 31, 31, 31, 4, 1, 24, 0, 1, 0, 0, false, false);
            searcher.RegisterPokemon3(20, 12, 31, 31, 28, 25, 2, 1, 19, 2, 2, 0, 0, false, false);
            searcher.RegisterPokemon4(31, 30, 1, 4, 31, 18, 2, 1, 11, 5, 3, 0, 0, false, false);
            int[] target = { 13, 16, 19, 27, 10, 31 };
            var res = searcher.Calculate(14, target);
            Assert.IsTrue(res.Count > 0, "No seed found");
            Assert.AreEqual(0x55ee358bb3c4d049ul, res[0]);
        }
        [TestMethod]
        ...
        public void Test_Fixed3_6_Deviation16()
        {
            SeedSearcher searcher = new SeedSearcher(SeedSearcher.Mode.Star35);
            searcher.RegisterLSB(0);
            searcher.RegisterPokemon1(25, 21, 1, 31, 31, 31, 3, 0, 12, 3, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(21, 31, 1, 31, 31, 31, 4, 0, 12, 1, 1, 0, 0, false, false);
            searcher.RegisterPokemon3(5, 31, 15, 18, 31, 22, 2, 1, 18, 1, 2, 0, 0, false, false);
            searcher.RegisterPokemon4(31, 15, 21, 24, 10, 31, 2, 0, 7, 0, 3, 0, 0, false, false);
            int[] target = { 25, 21, 1, 24, 18, 12 };
            var res = searcher.Calculate(16, target);
            Assert.IsTrue(res.Count > 0, "No seed found");
            Assert.AreEqual(0x43ff8b09ac6578b3ul, res[0]);
        }
        [TestMethod]
        public void Test_Fixed3_6_Deviation17()
        {
            SeedSearcher searcher = new SeedSearcher(SeedSearcher.Mode.Star35);
            searcher.RegisterLSB(1);
            searcher.RegisterPokemon1(28, 31, 31, 2, 31, 10, 3, 0, 2, 5, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(27, 31, 31, 31, 31, 2, 4, 1, 20, 4, 1, 0, 0, false, false);
            searcher.RegisterPokemon3(31, 5, 1, 10, 7, 31, 2, 1, 12, 0, 2, 0, 0, false, false);
            searcher.RegisterPokemon4(5, 12, 26, 31, 31, 1, 2, 0, 0, 5, 3, 0, 0, false, false);
            int[] target = { 28, 2, 10, 6, 3, 27 };
            var res = searcher.Calculate(17, target);
            Assert.IsTrue(res.Count > 0, "No seed found");
            Assert.AreEqual(0xb1ade62968e5fef0ul, res[0]);
        }
        [TestMethod]
        ...
        public void Test_Fixed3_6_Deviation23()
        {
            SeedSearcher searcher = new SeedSearcher(SeedSearcher.Mode.Star35);
            searcher.RegisterLSB(0);
            searcher.RegisterPokemon1(31, 9, 3, 4, 31, 31, 3, 0, 11, 0, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(31, 31, 3, 4, 31, 31, 4, 0, 11, 0, 1, 0, 0, false, false);
            searcher.RegisterPokemon3(4, 31, 7, 7, 1, 31, 2, 1, 24, 1, 2, 0, 0, false, false);
            searcher.RegisterPokemon4(31, 20, 12, 31, 14, 24, 2, 0, 10, 4, 3, 0, 0, false, false);
        ...
        public void Test_Fixed3_6_Deviation24()
        {
            SeedSearcher searcher = new SeedSearcher(SeedSearcher.Mode.Star35);
            searcher.RegisterLSB(0);
            searcher.RegisterPokemon1(7, 31, 31, 10, 31, 6, 3, 1, 19, 2, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(7, 31, 31, 31, 31, 0, 4, 0, 5, 2, 1, 0, 0, false, false);
            searcher.RegisterPokemon3(31, 9, 4, 15, 31, 0, 2, 0, 1, 5, 2, 0, 0, false, false);
            searcher.RegisterPokemon4(13, 1, 2, 16, 31, 31, 2, 0, 5, 5, 3, 0, 0, false, false);
            int[] target = { 7, 10, 6, 25, 25, 19 };
            var res = searcher.Calculate(24, target);
            Assert.IsTrue(res.Count > 0, "No seed found");
            Assert.AreEqual(0x800c22c48d686b03ul, res[0]);
        }
        [TestMethod]
        public void Test_Fixed3_6_Deviation25()
        {
            SeedSearcher searcher = new SeedSearcher(SeedSearcher.Mode.Star35);
            searcher.RegisterLSB(1);
            searcher.RegisterPokemon1(31, 15, 7, 14, 31, 31, 3, 0, 0, 5, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(31, 27, 31, 0, 31, 31, 4, 1, 16, 5, 1, 0, 0, false, false);
            searcher.RegisterPokemon3(28, 15, 18, 14, 31, 31, 2, 0, 17, 3, 2, 0, 0, false, false);
            searcher.RegisterPokemon4(31, 24, 28, 16, 11, 31, 2, 0, 10, 3, 3, 0, 0, false, false);
            int[] target = { 15, 7, 14, 20, 18, 27 };
            var res = searcher.Calculate(25, target);
            Assert.IsTrue(res.Count > 0, "No seed found");
            Assert.AreEqual(0x87ff9cce51fe7040ul, res[0]);
        }
        [TestMethod]
        public void Test_Fixed3_6_Deviation26()
        {
            SeedSearcher searcher = new SeedSearcher(SeedSearcher.Mode.Star35);
            searcher.RegisterLSB(0);
            searcher.RegisterPokemon1(31, 25, 31, 31, 20, 13, 3, 1, 18, 0, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(31, 31, 31, 31, 20, 13, 4, 1, 18, 0, 1, 0, 0, false, false);
            searcher.RegisterPokemon3(10, 31, 31, 12, 17, 29, 2, 1, 4, 1, 2, 0, 0, false, false);
            searcher.RegisterPokemon4(7, 31, 31, 13, 27, 25, 2, 1, 12, 2, 3, 0, 0, false, false);
            int[] target = { 25, 20, 13, 1, 10, 18 };
            var res = searcher.Calculate(26, target);
            Assert.IsTrue(res.Count > 0, "No seed found");
            Assert.AreEqual(0x964f7901de273897ul, res[0]);
        }
        [TestMethod]
        public void Test_Fixed3_6_Deviation27()
        {
            SeedSearcher searcher = new SeedSearcher(SeedSearcher.Mode.Star35);
            searcher.RegisterLSB(1);
            searcher.RegisterPokemon1(31, 3, 30, 21, 31, 31, 3, 0, 22, 3, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(31, 30, 21, 31, 31, 31, 4, 0, 22, 3, 1, 0, 0, false, false);
            searcher.RegisterPokemon3(1, 24, 4, 2, 31, 31, 2, 0, 6, 5, 2, 0, 0, false, false);
            searcher.RegisterPokemon4(20, 9, 8, 31, 14, 31, 2, 1, 23, 3, 3, 0, 0, false, false);
            int[] target = { 3, 30, 21, 14, 12, 30 };
            var res = searcher.Calculate(27, target);
            Assert.IsTrue(res.Count > 0, "No seed found");
            Assert.AreEqual(0x66a005ecf23cec50ul, res[0]);
        }
        [TestMethod]
        public void Test_Fixed3_6_Deviation28()
        {
            SeedSearcher searcher = new SeedSearcher(SeedSearcher.Mode.Star35);
            searcher.RegisterLSB(0);
            searcher.RegisterPokemon1(11, 18, 31, 7, 31, 31, 3, 1, 3, 2, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(18, 7, 31, 31, 31, 31, 4, 1, 3, 2, 1, 0, 0, false, false);
            searcher.RegisterPokemon3(18, 31, 2, 7, 27, 31, 2, 1, 4, 1, 2, 0, 0, false, false);
            searcher.RegisterPokemon4(12, 31, 0, 31, 9, 5, 2, 0, 9, 4, 3, 0, 0, false, false);
            int[] target = { 11, 18, 7, 25, 1, 31 };
            var res = searcher.Calculate(28, target);
            Assert.IsTrue(res.Count > 0, "No seed found");
            Assert.AreEqual(0xbee8bf3b99da2d8dul, res[0]);
        }
        [TestMethod]
        ...
        public void Test_Fixed3_6_Deviation30()
        {
            SeedSearcher searcher = new SeedSearcher(SeedSearcher.Mode.Star35);
            searcher.RegisterLSB(1);
            searcher.RegisterPokemon1(31, 31, 20, 31, 26, 30, 3, 0, 2, 4, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(31, 31, 26, 31, 31, 30, 4, 0, 2, 4, 1, 0, 0, false, false);
            searcher.RegisterPokemon3(12, 13, 31, 31, 22, 6, 2, 0, 14, 4, 2, 0, 0, false, false);
            searcher.RegisterPokemon4(28, 29, 31, 5, 26, 31, 2, 1, 15, 2, 3, 0, 0, false, false);
            int[] target = { 20, 26, 30, 16, 5, 2 };
            var res = searcher.Calculate(30, target);
            Assert.IsTrue(res.Count > 0, "No seed found");
            Assert.AreEqual(0x10cf4c25b6bc48b8ul, res[0]);
        }
        [TestMethod]
        public void Test_Fixed3_6_Deviation31()
        {
            SeedSearcher searcher = new SeedSearcher(SeedSearcher.Mode.Star35);
            searcher.RegisterLSB(0);
            searcher.RegisterPokemon1(21, 24, 31, 31, 31, 23, 3, 1, 3, 4, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(24, 23, 31, 31, 31, 31, 4, 1, 3, 4, 1, 0, 0, false, false);
            searcher.RegisterPokemon3(12, 4, 31, 31, 0, 21, 2, 0, 4, 2, 2, 0, 0, false, false);
            searcher.RegisterPokemon4(31, 5, 31, 24, 19, 23, 2, 1, 15, 0, 3, 0, 0, false, false);
            int[] target = { 21, 24, 23, 25, 3, 3 };
            var res = searcher.Calculate(31, target);
            Assert.IsTrue(res.Count > 0, "No seed found");
            Assert.AreEqual(0xca90fb7f5ef5a22dul, res[0]);
        }
        [TestMethod]
        ...
        public void Test_Fixed3_6_Deviation33()
        {
            SeedSearcher searcher = new SeedSearcher(SeedSearcher.Mode.Star35);
            searcher.RegisterLSB(1);
            searcher.RegisterPokemon1(31, 30, 31, 8, 18, 31, 3, 0, 12, 0, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(31, 31, 31, 12, 29, 31, 4, 0, 11, 0, 1, 0, 0, false, false);
            searcher.RegisterPokemon3(7, 31, 23, 31, 16, 11, 2, 1, 4, 1, 2, 0, 0, false, false);
            searcher.RegisterPokemon4(28, 31, 11, 8, 4, 31, 2, 1, 6, 1, 3, 0, 0, false, false);
            int[] target = { 30, 8, 18, 14, 23, 25 };
            var res = searcher.Calculate(33, target);
            Assert.IsTrue(res.Count > 0, "No seed found");
            Assert.AreEqual(0xa40e07dc65799cb8ul, res[0]);
        }
        [TestMethod]
        public void Test_Fixed3_6_Deviation34()
        {
            SeedSearcher searcher = new SeedSearcher(SeedSearcher.Mode.Star35);
            searcher.RegisterLSB(0);
            searcher.RegisterPokemon1(12, 31, 22, 23, 31, 31, 3, 1, 9, 5, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(31, 31, 24, 31, 31, 31, 4, 0, 15, 4, 1, 0, 0, false, false);
            searcher.RegisterPokemon3(28, 31, 5, 31, 10, 19, 2, 0, 6, 1, 2, 0, 0, false, false);
            searcher.RegisterPokemon4(2, 30, 31, 17, 3, 31, 2, 1, 2, 2, 3, 0, 0, false, false);
            int[] target = { 12, 22, 23, 21, 20, 9 };
            var res = searcher.Calculate(34, target);
            Assert.IsTrue(res.Count > 0, "No seed found");
            Assert.AreEqual(0xd590d450fba73ccful, res[0]);
        }
        [TestMethod]
        public void Test_Fixed3_6_Deviation35()
        {
            SeedSearcher searcher = new SeedSearcher(SeedSearcher.Mode.Star35);
            searcher.RegisterLSB(0);
            searcher.RegisterPokemon1(31, 19, 31, 27, 20, 31, 3, 1, 15, 2, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(31, 27, 31, 31, 20, 31, 4, 1, 15, 2, 1, 0, 0, false, false);
            searcher.RegisterPokemon3(6, 31, 17, 9, 31, 13, 2, 1, 22, 5, 2, 0, 0, false, false);
            searcher.RegisterPokemon4(20, 31, 0, 29, 28, 31, 2, 1, 21, 1, 3, 0, 0, false, false);
            int[] target = { 19, 27, 20, 3, 2, 29 };
            var res = searcher.Calculate(35, target);
            Assert.IsTrue(res.Count > 0, "No seed found");
            Assert.AreEqual(0xf892b015089d6ccdul, res[0]);
        }
        [TestMethod]
        ...
        public void Test_Fixed3_6_Deviation37()
        {
            SeedSearcher searcher = new SeedSearcher(SeedSearcher.Mode.Star35);
            searcher.RegisterLSB(1);
            searcher.RegisterPokemon1(31, 13, 25, 30, 31, 31, 3, 0, 1, 5, 1, 0, 0, false, false);
            searcher.RegisterPokemon2(31, 31, 30, 18, 31, 31, 4, 1, 8, 5, 1, 0, 0, false, false);
            searcher.RegisterPokemon3(24, 28, 17, 31, 21, 31, 2, 1, 13, 3, 2, 0, 0, false, false);
            searcher.RegisterPokemon4(23, 21, 28, 31, 31, 26, 2, 0, 20, 4, 3, 0, 0, false, false);
            int[] target = { 13, 25, 30, 18, 17, 1 };
            var res = searcher.Calculate(37, target);
            Assert.IsTrue(res.Count > 0, "No seed found");
            Assert.AreEqual(0xf101cc99d97677fcul, res[0]);
        }
        [TestMethod]
